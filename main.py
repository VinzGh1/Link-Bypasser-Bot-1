...
# bot
bot_token = os.environ.get("TOKEN", "5275865551:AAFvSvdn-wltqw5sU2sUiVaWLdZ3eRUAoyg")
api_hash = os.environ.get("HASH", "2589472") 
api_id = os.environ.get("ID", "5243628014db9798d6775b330e542602")
